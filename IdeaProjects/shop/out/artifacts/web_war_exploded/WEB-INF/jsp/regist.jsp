...
<script>
	...
	function checkUsername(){
					var Num = parseInt(document.getElementById("username").value)
					if(isNaN(Num)){
						alert("请输入数字");
...
<div class="container header">
	<div class="span5">
		<div class="logo">
			<a href="#">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.png" alt="惠多多电脑办公">
			</a>
		</div>
	</div>
	<div class="span9">
					...
					<form id="registerForm" action="${ pageContext.request.contextPath }/user_regist.action"  method="post" novalidate="novalidate" onsubmit="return checkForm();">
						<table>
							<tbody><tr>
								...
								<td>
								<input type="text" id="username" name="username" placeholder="只能输入数字" οnkeyup="value=value.replace(/[^(\d)]/g,'')" class="text" maxlength="20" onblur="checkUsername()"/>
									<span id="span1"></span>
								</td>
							</tr>
							<tr>
